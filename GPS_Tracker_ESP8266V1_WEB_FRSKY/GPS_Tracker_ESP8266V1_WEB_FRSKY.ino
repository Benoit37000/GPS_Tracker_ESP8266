...
void loop()
{
  ...
  if (!gps.location.isValid()) {
    ...
    GPS[1]=gps.location.lat(); 
    GPS[2]=gps.location.lng(); 
    GPS[3]=gps.altitude.meters();
    ...
    drone_idfr.set_current_position(GPS[1], GPS[2], (int16_t)GPS[3]);
    drone_idfr.set_heading((int16_t)GPS[4]);
    drone_idfr.set_ground_speed(GPS[5]);
